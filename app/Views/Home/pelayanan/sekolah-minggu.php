    ...
    <div class="container">
        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item">
                    <img src="/Public/assets/img/pelayanan/sunday/img-maps-2.png" class="d-block w-100" alt="Sekolah Minggu Activity 3">
                </div>
            </div>
    ...
    <div class="container text-center text-white">
        ...
        <div class="row mt-4">
            <div class="col-md-4" style="z-index: 1;">
                <img src="/Public/assets/img/pelayanan/sekolah/bernyanyi.jpg" alt="Sing Icon" class="img-fluid mb-2">
            ...
            <div class="col-md-4" style="z-index: 1;">
                <img src="/Public/assets/img/pelayanan/sekolah/membaca.png" alt="Bible Icon" class="img-fluid mb-2">
            ...
            <div class="col-md-4" style="z-index: 1;">
                <img src="/Public/assets/img/pelayanan/sekolah/bermain.jpg" alt="Play Icon" class="img-fluid mb-2">
